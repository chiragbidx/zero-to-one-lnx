...
export default function Client({ redirectTo, flashStatus, flashMessage }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Join TeamTrackr",
        description: "Create your free TeamTrackr account—start organizing clients and projects instantly.",
      };
    }

    return {
      id: "signin",
      title: "Sign in to TeamTrackr",
      description: "Manage your client relationships and project workflows securely.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Centralize your client workflows and team success.
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Secure access, organized data. Onboard your team and unlock end-to-end management for clients, projects, and invoices.
              </p>
            </div>
